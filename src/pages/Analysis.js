...
export default function Analysis() {
  ...
  const currentMonthIndex = data.currentMonthIndex;
  const last6Months = data.months.slice(currentMonthIndex - 5, currentMonthIndex + 1);
  const last6Revenue = data.revenue.slice(currentMonthIndex - 5, currentMonthIndex + 1);
  const last6Orders = data.orders.slice(currentMonthIndex - 5, currentMonthIndex + 1);
  const last6Profit = data.profit.slice(currentMonthIndex - 5, currentMonthIndex + 1);
  ...
  const barChartData = {
    ...
    datasets: [
      ...
      },
      {
        ...
        data: timeRange === '6months' ? last6Profit : data.profit,
  ...
  const metrics = [
    {
      title: 'Total Revenue',
      value: `₹${(data.revenue[currentMonthIndex] * 1000).toLocaleString()}`,
      change: '+24.3%',
      trend: 'up',
    ...
    {
      title: 'Total Orders',
      value: data.orders[currentMonthIndex].toLocaleString(),
      change: '+18.7%',
      trend: 'up',
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          ...
          >
            <motion.div 
              ...
              className="inline-block px-5 py-2 rounded-full bg-white/5 backdrop-blur-sm border border-white/10 mb-5"
            >
          ...
          >
            {metrics.map((metric, idx) => (
              <motion.div
                ...
                className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 relative overflow-hidden group border border-white/10"
              >
