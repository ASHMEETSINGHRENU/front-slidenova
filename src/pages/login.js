    ...
    const handleGoogleSuccess = async (credentialResponse) => {
        try {
            ...
            const res = await axios.post(
                "https://backend-slidenova.onrender.com/api/auth/google",
                {
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="flex gap-3">
                            <motion.button
                                whileHover={{ scale: 1.05, y: -2 }}
                                whileTap={{ scale: 0.95 }}
                                className="flex-1 py-2 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 text-gray-400 hover:bg-gray-500/10 hover:border-gray-500/20 transition-all duration-300"
                            >
                            ...
                            <motion.button
                                whileHover={{ scale: 1.05, y: -2 }}
                                whileTap={{ scale: 0.95 }}
                                className="flex-1 py-2 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 text-gray-400 hover:bg-blue-500/10 hover:border-blue-500/20 transition-all duration-300"
                            >
